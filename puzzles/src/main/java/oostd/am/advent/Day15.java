...
public class Day15 {
    ...
    static class CaveSystem {
        ...
        long[][] calculateRiskRoute(Position start, Position end) {
    ...
    public static void main(String[] args) {
        ...
        long[][] longs = caveSystem.calculateRiskRoute(
                new Position(0, 0),
                new Position(caveSystem.riskMap[0].length - 1, caveSystem.riskMap.length - 1));
